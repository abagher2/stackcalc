...
!!! note "Project status"
    This post records the watch-first design work. The companion app is available on the [App Store](https://apps.apple.com/app/id6801788040); the physical project remains an unpowered, tool-free mechanical prototype while the RP2350 PCB is developed. The staged build log is on [Hackaday](https://hackaday.io/project/206743-stackcalc32-a-tactile-rpn-calculator).

![StackCalc on Apple Watch](../../assets/watch-rpn-stack.png)

*The actual StackCalc Apple Watch interface used to explore compact calculator controls.*

![Printed StackCalc faceplate iterations](../../assets/prototype-faceplate-iterations.jpg)

*Printed faceplate iterations used to evaluate control spacing and label treatment. These are mechanical prototypes, not working electronics.*
