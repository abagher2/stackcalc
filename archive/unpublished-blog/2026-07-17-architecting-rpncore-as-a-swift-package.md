...
!!! note "Project status"
    This post captures the shared-core direction. The iPhone and Apple Watch app is available on the [App Store](https://apps.apple.com/app/id6801788040). The physical calculator is currently a tool-free mechanical prototype; its RP2350 PCB has not yet been fabricated. Follow the staged [Hackaday build log](https://hackaday.io/project/206743-stackcalc32-a-tactile-rpn-calculator) for the current hardware record.

![StackCalc iPhone interface](../../assets/iphone-rpn-stack.png)

*The actual StackCalc iPhone interface. App screenshots show companion software, not a powered physical prototype.*
